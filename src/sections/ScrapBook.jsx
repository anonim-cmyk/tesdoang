...
function Scrapbook() {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-200 overflow-hidden">
      ...
      >
        {/* Halaman 1 */}
        <div className="relative bg-[#f5e7d8]">
          {/* Teks Utama */}
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-2">
            <h1 className="text-2xl font-header font-bold relative">
              <span className="text-6xl">Happy</span> <br />{" "}
              <span className="text-6xl">Birthday</span>{" "}
              <span className="ml-2 absolute font-serif">24th</span>
            </h1>
          ...
          <img
            ...
            alt="pelangi"
            className="absolute top-0 left-0 w-32 h-20 -rotate-[10deg]"
          />
          <img
        ...
        {/* Halaman 2 */}
        <div className="bg-[#f5e7d8] overflow-hidden">
          <div className="relative flex flex-col gap-4 justify-center items-center h-full -translate-y-11">
            <h1 className="text-6xl text-center font-header font-bold">
              Lovely
            </h1>
          ...
          <img
            src="/images/daun.png"
            alt="daun"
            className="w-16 h-16 absolute top-1/2 -translate-y-1/2 -left-2"
          />
          <img
            src="/images/plus.svg"
            alt="plus"
            className="w-16 h-16 absolute bottom-1/6 left-4 -translate-y-2"
          />
          <img
            src="/images/plus.svg"
            alt="plus"
          ...
          <img
            src="/images/plus.svg"
            alt="plus"
            className="w-5 h-5 absolute bottom-0 left-5 -translate-y-20"
          />
          <img
            src="/images/plus.svg"
            alt="plus"
            className="w-5 h-5 absolute bottom-0 left-10 -translate-y-16"
          />
          <img
            src="/images/plus.svg"
            alt="plus"
            className="w-10 h-10 absolute bottom-0 left-16 -translate-y-16"
          />
          <img
            src="/images/play.png"
            alt="play"
            className="w-28 h-28 absolute top-0 translate-y-16 -left-4 rotate-45"
          />
          <img
          ...
          <img
            ...
            alt="garis"
            className="w-32 h-32 absolute bottom-16 -translate-y-16 left-1/2 translate-x-24 rotate-[20deg]"
          />
          <img
            src="/images/love.png"
            alt="garis"
        ...
        {/* Halaman 4 */}
        <div className="flex flex-col items-center justify-center bg-[#f5e7d8] relative overflow-hidden">
          <div className="relative flex flex-col h-full justify-center items-center gap-6">
            <h1 className="text-6xl font-header font-bold text-center">
              My Girlfriend
            </h1>
            <img
            ...
            <img
              src="/images/bunga-kecil.png"
              alt="bunga"
              className="w-14 h-14 absolute top-4 left-14"
            />
            <img
              src="/images/bunga-kecil.png"
              alt="bunga"
              className="w-14 h-14 absolute right-4"
            />
            <img
              src="/images/bunga-kecil.png"
              alt="bunga"
              className="w-14 h-14 absolute right-10 bottom-0 -translate-y-6"
            />
            {/* Lapisan luar (putih) */}
            <div className="p-2 bg-yellow-900 w-48 h-64">
              ...
              <div className="relative border-2 border-white w-full h-full">
                <img
                  src="/images/image.png"
                  alt="img"
                  className="absolute top-1/2 w-36 h-48 -translate-y-1/2 left-1/2 -translate-x-1/2 flex items-center justify-center"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center bg-[#f5e7d8] relative overflow-hidden">
            ...
            <div className="relative p-2 bg-yellow-900 w-42 h-52">
              <div className="relative border-2 border-white w-full h-full">
                <img
                  src="/images/image.png"
                  alt="img"
                  className="absolute top-1/2 w-32 h-42 -translate-y-1/2 left-1/2 -translate-x-1/2"
                />
              </div>
            </div>
          </div>
          <img
            src="/images/bunga-kecil.png"
            alt="bunga"
            className="w-14 h-14 absolute right-15 top-1/2 -translate-y-32"
          />
            ...
            <div className="p-2 bg-yellow-900 w-42 h-52">
              <div className="relative border-2 border-white w-full h-full">
                <img
                  src="/images/image.png"
                  alt="img"
                  className="absolute top-1/2 w-32 h-42 -translate-y-1/2 left-1/2 -translate-x-1/2 flex items-center justify-center"
                />
              </div>
            </div>
          </div>
          <img
            src="/images/bunga-kecil.png"
            alt="bunga"
            className="w-14 h-14 absolute left-15 top-1/2 translate-y-14"
          />
          <img
            src="/images/bunga-dua.png"
            alt="bunga"
            className="w-32 h-48 absolute bottom-0 translate-y-14"
          />
          <img
            src="/images/bunga-dua.png"
            alt="bunga"
            className="w-32 h-48 absolute bottom-0 right-1/2 translate-y-14"
          />
        </div>

        {/* Halaman 6 */}
        <div className="bg-[#f5e7d8] relative overflow-hidden">
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-6xl font-header font-bold">Remember!!</h1>
            <p className="text-sm font-serif font-bold">If you need someone</p>
            <span className="uppercase font-bold font-serif text-xl">
              I'm Always Here
            </span>
            <img
              src="/images/images2.jpg"
              alt="image"
              className="w-48 h-64 rounded-t-full"
            />
          </div>
          <img
        ...
        {/* Halaman 7 */}
        <div className="relative bg-[#f5e7d8] overflow-hidden p-4">
          <div className="flex flex-col items-center justify-center h-full gap-4">
            <h1 className="text-2xl -rotate-12 font-header font-bold text-center">
              Special <br /> Wishes
            </h1>
            <div className="relative w-full bg-yellow-800 p-3 text-center">
              ...
              <p className="text-sm font-serif text-white z-10 relative">
          ...
          <img
            ...
            alt="balon"
            className="absolute top-0 right-0 w-32 h-32 -rotate-12 translate-x-8 translate-y-15"
          />
          <img
            src="/images/image-bintang.png"
            alt="bintang"
            className="absolute -right-2 bottom-0 rotate-y-180"
          />
        </div>
        ...
        <div className="relative bg-[#f5e7d8] overflow-hidden p-4">
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="relative text-6xl font-header font-bold text-center">
              <img
        ...
        <div className="bg-[#f5e7d8] relative overflow-hidden">
          ...
          />
          <div className="flex flex-col items-center justify-center h-full gap-6">
            <h1 className="relative text-6xl text-center font-header font-bold">
              About You
              <div className="absolute top-0 right-0 translate-x-16">
                <img src="/images/love-tiga.png" alt="love" />
              </div>
            </h1>
            <div className="flex w-full h-[272px] items-center justify-center">
              <div className="flex items-center justify-center relative w-full h-full">
                ...
                <img
                  src="/images/image.png"
                  alt="image"
                  className="w-64 h-64 rounded-full object-cover -rotate-[25deg] absolute -right-2 -translate-x-10"
                />
              </div>
            </div>
          </div>
        ...
        {/* Halaman 11 */}
        <div className="flex flex-col items-center justify-center bg-[#f5e7d8] relative h-full w-full overflow-hidden">
        ...
        {/* Halaman 12 */}
        <div className="relative flex flex-col items-center justify-center bg-[#f5e7d8] overflow-hidden">
          <h1 className="relative text-5xl text-center font-header font-bold mt-8">
            Our Moment
            <img
              src="/images/daun-empat.png"
              alt="daun"
              className="absolute top-0 right-0 -translate-y-4"
            />
            <img src="/images/garis-empat.png" alt="garis" />
          </h1>
            ...
            <div className="p-2 bg-yellow-900 w-36 h-48 -translate-y-15">
              <div className="relative border-2 border-white w-full h-full">
                <img
                  ...
                  alt="img"
                  className="object-fill w-32 h-42"
                />
              </div>
            </div>
            ...
            <div className="p-2 bg-yellow-900 w-36 h-48">
              <div className="relative border-2 border-white w-full h-full">
                <img
                  src="/images/images-3.jpg"
                  alt="img"
                  className="objecet-fill w-32 h-42"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center bg-[#f5e7d8] relative overflow-hidden">
          <img
            ...
            alt="titik"
            className="absolute top-1/2 left-0 -translate-y-22"
          />
          <img
            src="/images/love.png"
            alt="love"
        ...
        {/* Halaman 14 */}
        <div className="bg-[#f5e7d8] relative overflow-hidden">
          <h1 className="text-5xl font-header font-bold text-center mt-10">
            The Rules Love
          </h1>
        ...
        <div className="flex flex-col items-center justify-center bg-[#f5e7d8] relative overflow-hidden">
          <div className="grid grid-cols-2 items-center h-full p-4">
            <p className="text-lg font-serif px-4 text-center">
            ...
            <img
              ...
              alt="image"
              className="object-contain translate-y-28"
            />
          </div>
          ...
          <img
            ...
            alt="image"
            className="w-32 h-32 absolute top-0 right-0"
          />
        </div>

        {/* Halaman 16 */}
        <div className="bg-[#f5e7d8] relative overflow-hidden h-screen">
          <div className="flex flex-col items-center justify-center h-full">
            <div className="relative -translate-y-10 flex flex-col w-full h-[220px] items-center justify-center">
              <h1 className="font-bold font-header text-6xl">Message</h1>
              <img
                src="/images/garis-dua.png"
                alt="garis"
                className="rotate-x-180 -rotate-[25deg] absolute top-24"
              />
              <img
          ...
          <img
            ...
            alt="titik"
            className="absolute bottom-0 left-32 -translate-y-14"
          />
          <img
            src="/images/plus-new.png"
            alt="plus"
        ...
        {/* Halaman 17 */}
        <div className="bg-[#f5e7d8] relative overflow-hidden h-screen px-8">
          <div className="flex items-center justify-center h-full">
            <div className="h-auto bg-amber-600 rounded-md p-4">
              <p className="text-md text-center font-serif font-semibold">
          ...
          <img
            ...
            alt="bunga"
            className="absolute bottom-0 translate-y-15 -left-16 -rotate-14 overflow-hidden"
          />
          <img
        ...
        <div className="bg-[#f5e7d8] relative overflow-hidden h-screen px-8">
          <div className="flex items-center justify-center h-full">
            <div className="text-6xl text-center font-bold font-header flex flex-col gap-6">
              <span>I</span>
              <span>Always</span>
              <span>miss</span>
              <span>you</span>
          ...
          <img
            ...
            alt="pesta"
            className="absolute top-1/2 translate-y-3 right-0"
          />
          <img
